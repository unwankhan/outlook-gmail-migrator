// frontend/src/components/auth/LoginForm.jsx - UPDATED
import React, { useState } from 'react'
import { Link, useNavigate } from 'react-router-dom'
import { useAuth } from '../../contexts/AuthContext'
import { Eye, EyeOff, Mail, Lock, ArrowRight, Cloud, Sparkles } from 'lucide-react'
                ...
                >
                    {['Secure', 'Fast', 'Reliable'].map((feature, index) => (
                        <motion.div
                            ...
                            className="text-center p-3 bg-white/50 backdrop-blur-sm rounded-xl border border-slate-200"
                        >
                            <div className="w-6 h-6 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-1">
                                <Cloud className="h-3 w-3 text-white" />
                            </div>
                            <h3 className="text-xs font-semibold text-slate-700">{feature}</h3>
                        </motion.div>
                    ))}
                </motion.div>
            </div>
